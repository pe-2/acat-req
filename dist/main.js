...
/***/ "./src/createGoReq/createGoReq.js":
/*!****************************************!*\
  !*** ./src/createGoReq/createGoReq.js ***!
  \****************************************/
...
/* harmony export */   "default": () => (/* binding */ CreateGlobalReq)
/* harmony export */ });
/* harmony import */ var _mount_mount__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mount/mount */ "./src/mount/mount.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_1__);


class CreateGlobalReq {
    constructor(reqOpts, baseOpt) {
        reqOpts.forEach(element => {
            (0,_mount_mount__WEBPACK_IMPORTED_MODULE_0__["default"])(this, element);
        });
        this.baseOpt = baseOpt;
        for (let i in baseOpt) {
            if (i === 'headers') {
                for (let j in baseOpt[i]) {
                    (axios__WEBPACK_IMPORTED_MODULE_1___default().defaults)[i][j] = baseOpt[i][j];
                }
                continue;
            }
            (axios__WEBPACK_IMPORTED_MODULE_1___default().defaults)[i] = baseOpt[i];
        }
    }
    getData(name) {
...
/* harmony import */ var _transD_transD__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../transD/transD */ "./src/transD/transD.js");


function mount(target, reqOpt) {
    const { name } = reqOpt;
    if (name === undefined) {
    ...
    target[name] = function (moreOpt) {
        ...
        return axios__WEBPACK_IMPORTED_MODULE_0___default()(Object.assign(reqOpt, moreOpt)).then(res => {
            target.recordReqTime(name);
            let { data } = res;
            let { mapper } = reqOpt;
            if (reqOpt.mapper) {
                target[`${name}_data`] = (0,_transD_transD__WEBPACK_IMPORTED_MODULE_1__["default"])(data, mapper);
...
/* harmony export */ });
function transformData(data, mapper) {
    let newData = {};
    let oldPropArr = [];
    for (let i in mapper) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "acat_req": () => (/* binding */ acat_req)
/* harmony export */ });
/* harmony import */ var _createGoReq_createGoReq__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createGoReq/createGoReq */ "./src/createGoReq/createGoReq.js");

function acat_req(reqs, baseOpt) {
    return new _createGoReq_createGoReq__WEBPACK_IMPORTED_MODULE_0__["default"](reqs, baseOpt);
}
